...
use OmnibusVendor\Monolog\Utils;
use OmnibusVendor\PhpConsole\Connector;
use OmnibusVendor\PhpConsole\Handler;
use OmnibusVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('OmnibusVendor\\PhpConsole\\Connector')) {

...
namespace OmnibusVendor\WPDesk\Tracker;

use OmnibusVendor\WPDesk\PluginBuilder\Plugin\Hookable;
use OmnibusVendor\WPDesk\View\Renderer\SimplePhpRenderer;
use OmnibusVendor\WPDesk\View\Resolver\DirResolver;
    ...
    public function admin_init()
    {
        if (isset($_GET['wpdesk_tracker']) && $_GET['wpdesk_tracker'] === $this->plugin_slug) {
            if (isset($_GET['allow']) && isset($_GET['security']) && wp_verify_nonce($_GET['security'], $this->plugin_slug)) {
                $persistence = new \OmnibusVendor\WPDesk_Tracker_Persistence_Consent();

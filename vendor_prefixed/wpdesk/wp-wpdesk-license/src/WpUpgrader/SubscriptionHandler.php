...
namespace OmnibusVendor\WPDesk\License\WpUpgrader;
...
class SubscriptionHandler implements Hookable
{
    ...
    {
        if (\function_exists('OmnibusVendor\\get_current_screen')) {

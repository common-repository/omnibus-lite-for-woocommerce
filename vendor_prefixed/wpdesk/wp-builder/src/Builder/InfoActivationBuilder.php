...
namespace OmnibusVendor\WPDesk\PluginBuilder\Builder;
...
use OmnibusVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
...
class InfoActivationBuilder extends AbstractBuilder
{
     ...
     */
    public function __construct(\OmnibusVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;

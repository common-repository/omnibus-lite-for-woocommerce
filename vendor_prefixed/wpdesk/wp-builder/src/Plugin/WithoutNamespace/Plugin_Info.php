...
if (!\interface_exists('OmnibusVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('OmnibusVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('OmnibusVendor\\WPDesk_Has_Plugin_Info')) {

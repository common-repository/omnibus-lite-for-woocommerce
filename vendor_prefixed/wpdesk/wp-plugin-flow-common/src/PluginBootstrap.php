...
namespace OmnibusVendor\WPDesk\Plugin\Flow;

use OmnibusVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory;
/**
...
final class PluginBootstrap
{
     ...
     */
    private function init_translations(\OmnibusVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \OmnibusVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \OmnibusVendor\WPDesk_Plugin_Info();

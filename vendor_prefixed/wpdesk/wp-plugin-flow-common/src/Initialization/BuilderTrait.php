...
namespace OmnibusVendor\WPDesk\Plugin\Flow\Initialization;

use OmnibusVendor\WPDesk\PluginBuilder\Plugin\Activateable;
use OmnibusVendor\WPDesk\PluginBuilder\Plugin\Deactivateable;
...
trait BuilderTrait
{
     ...
     * @return SlimPlugin
     */
    private function build_plugin(\OmnibusVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    private function init_register_hooks(\OmnibusVendor\WPDesk_Plugin_Info $plugin_info, SlimPlugin $plugin)
    {

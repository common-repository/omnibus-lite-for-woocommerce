...
if (!\interface_exists('OmnibusVendor\\WPDesk_Requirement_Checker')) {
    require_once 'Requirement_Checker.php';
}
if (!\class_exists('OmnibusVendor\\WPDesk_Basic_Requirement_Checker')) {
    /**
    ...
    class WPDesk_Basic_Requirement_Checker implements WPDesk_Requirement_Checker
    {
        ...
        {
            return \defined('OmnibusVendor\\WC_VERSION') && \version_compare(\OmnibusVendor\WC_VERSION, $min_version, '>=');
        }
        /**
        ...
        private static function retrieve_plugins_data_in_transient()
        {
            ...
            if ($plugins === \false) {
                if (!\function_exists('OmnibusVendor\\get_plugins')) {
                    require_once \ABSPATH . '/wp-admin/includes/plugin.php';
                }
                $plugins = \function_exists('OmnibusVendor\\get_plugins') ? get_plugins() : array();
        ...
        private function prepare_plugin_repository_install_url($plugin_info)
        {
            ...
            if (\function_exists('OmnibusVendor\\wp_nonce_url') && \function_exists('OmnibusVendor\\wp_create_nonce')) {
        ...
        private function prepare_plugin_repository_require_notice($plugin_info)
        {
            ...
            if (!self::is_wp_plugin_active($name)) {
                ...
                if (\function_exists('OmnibusVendor\\wp_create_nonce')) {

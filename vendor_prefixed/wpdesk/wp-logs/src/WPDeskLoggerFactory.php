...
use OmnibusVendor\Monolog\Handler\StreamHandler;
use Psr\Log\LogLevel;
use OmnibusVendor\WPDesk\Logger\WC\WooCommerceCapture;
use OmnibusVendor\WPDesk\Logger\WP\WPCapture;
/**
...
class WPDeskLoggerFactory extends BasicLoggerFactory
{
    ...
    {
        if (!\defined('OmnibusVendor\\WC_LOG_THRESHOLD')) {
            \define('OmnibusVendor\\WC_LOG_THRESHOLD', self::LEVEL_WC);
        }

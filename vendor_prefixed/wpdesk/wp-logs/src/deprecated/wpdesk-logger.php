...
if (!\class_exists('OmnibusVendor\\WPDesk_Logger')) {
    /**
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \OmnibusVendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            if (\defined('OmnibusVendor\\WC_VERSION')) {
                if (\version_compare(\OmnibusVendor\WC_VERSION, '3.0', '<')) {

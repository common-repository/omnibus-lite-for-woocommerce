...
if (!\function_exists('OmnibusVendor\\WPDeskInitWpNoticeAjaxHandler')) {
    /**
    ...
    {
        $ajax_handler = new \OmnibusVendor\WPDesk\Notice\AjaxHandler($assetsUrl);
        $ajax_handler->hooks();
        return $ajax_handler;
    }
}
if (!\function_exists('OmnibusVendor\\wpdesk_init_wp_notice_ajax_handler')) {
    /**
...
if (!\function_exists('OmnibusVendor\\WPDeskWpNotice')) {
    /**
     * Creates Notice.
     *
    ...
    {
        return \OmnibusVendor\WPDesk\Notice\Factory::notice($noticeContent, $noticeType, $dismissible, $priority);
    }
}
if (!\function_exists('OmnibusVendor\\wpdesk_wp_notice')) {
    /**
     * Creates Notice.
     *
...
if (!\function_exists('OmnibusVendor\\WPDeskWpNoticeInfo')) {
    /**
     * Creates Notice Info.
     *
     * @param string $noticeContent Notice content.
    ...
    {
        return \OmnibusVendor\WPDesk\Notice\Factory::notice($noticeContent, \OmnibusVendor\WPDesk\Notice\Notice::NOTICE_TYPE_INFO, $dismissible, $priority);
    }
}
if (!\function_exists('OmnibusVendor\\wpdesk_wp_notice_info')) {
    /**
     * Creates Notice Info.
     *
...
if (!\function_exists('OmnibusVendor\\WPDeskWpNoticeError')) {
    /**
    ...
    {
        return \OmnibusVendor\WPDesk\Notice\Factory::notice($noticeContent, \OmnibusVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR, $dismissible, $priority);
    }
}
if (!\function_exists('OmnibusVendor\\wpdesk_wp_notice_error')) {
    /**
     * Creates Notice Error.
     *
...
if (!\function_exists('OmnibusVendor\\WPDeskWpNoticeWarning')) {
    /**
    ...
    {
        return \OmnibusVendor\WPDesk\Notice\Factory::notice($noticeContent, \OmnibusVendor\WPDesk\Notice\Notice::NOTICE_TYPE_WARNING, $dismissible, $priority);
    }
}
if (!\function_exists('OmnibusVendor\\wpdesk_wp_notice_warning')) {
    /**
     * Creates Notice Warning.
     *
...
if (!\function_exists('OmnibusVendor\\WPDeskWpNoticeSuccess')) {
    /**
    ...
    {
        return \OmnibusVendor\WPDesk\Notice\Factory::notice($noticeContent, \OmnibusVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS, $dismissible, $priority);
    }
}
if (!\function_exists('OmnibusVendor\\wpdesk_wp_notice_success')) {
    /**
     * Creates Notice Success.
     *
...
if (!\function_exists('OmnibusVendor\\WPDeskPermanentDismissibleWpNotice')) {
    /**
    ...
    {
        return \OmnibusVendor\WPDesk\Notice\Factory::permanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
if (!\function_exists('OmnibusVendor\\wpdesk_permanent_dismissible_wp_notice')) {
    /**
     * Creates Permanent Dismissible Notice.
     *
